        ...
        <div class="card-header py-3">
            <div class="col-md-12">
                <h6 class="m-0 font-weight-bold float-right text-primary">
                    <p><a href="{{route('admin.task.index')}}" class="btn btn-primary btn-sm">All Tasks</a></p>
                    <p><a href="{{route('admin.task.edit',$task->id)}}" class="btn btn-primary btn-sm">Update
                            Task</a></p>
                </h6>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <dl>
                            <dt><b class="border-bottom border-primary">Task Member</b></dt>
                            <dd>
                                @if($task->user_id != 0 )
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route('admin.comment',$task->id)}}" method="post">
                                            @csrf
